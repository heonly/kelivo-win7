...
.DESCRIPTION
    ...
    structure defined in 搂7.1 of the plan, and generates a portable
...
$vcredistSrc = Join-Path $PSScriptRoot "..\files\vcredist_x64.exe"
...
if ($IncludePrereqMsu) {
    $msuSrc = Join-Path $PSScriptRoot "..\files\prerequisite\KB2670838-x64.msu"
...
if ($IncludeWebview2) {
    ...
    $wv2Src = Join-Path $PSScriptRoot "..\files\MicrosoftEdgeWebview2Setup.exe"
...
$setupScript = Join-Path $PSScriptRoot "install_prereq.bat"
